...
rule cryptoshuffler
{
    ...
    strings:
        ...
        $url1 = "http://t2.symcb.com0" ascii
        $url2 = "http://tl.symcb.com/tl.crl0" ascii
        $url3 = "http://tl.symcb.com/tl.crt0" ascii
        $url4 = "http://tl.symcd.com0&" ascii
        $url5 = "https://www.thawte.com/cps0/" ascii
